...
authRouter.post("/login", rateLimitMiddleware, loginOrEmailValidator,inputCheckErrorsMiddleware, loginCheckController)
...
authRouter.post("/registration",rateLimitMiddleware, userInputValidator, inputCheckErrorsMiddleware, registerUserController)
authRouter.post("/registration-confirmation",rateLimitMiddleware, registrationConfirmationValidator, inputCheckErrorsMiddleware, confirmRegistrationController)
authRouter.post("/registration-email-resending",rateLimitMiddleware, registrationEmailValidator, inputCheckErrorsMiddleware, emailResendingController)
