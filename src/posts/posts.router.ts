...
//TODO Надо сделать создание комментариев и как то засунуть их внутри request чтобы в комментах получить commentatorInfo
...
postsRouter.post("/:postId/comments", jwtMiddleware, commentInputValidator, inputCheckErrorsMiddleware, postService.createComment)
