...
import {ITokenInfo, IUserAccountDbModel} from "../types/auth-db-type";
...
export const tokenCollection:Collection<ITokenInfo> =db.collection<ITokenInfo>(SETTINGS.OLD_TOKEN_COLLECTION_NAME)
