...
import {IUserDbMongo, IUserInputModel, IUserOutputModel} from "../src/types/user-db-type";
import {ICommentInputModel, ICommentOutputModel} from "../src/types/comment-db-type";
import {ILikeInputModel, LikeStatuses} from "../src/types/like-db-type";
...
export const likeStatusLike:ILikeInputModel={
    likeStatus: LikeStatuses.LIKE
}
export const likeStatusDislike:ILikeInputModel={
